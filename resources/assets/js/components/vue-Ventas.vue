  ...
  <div class='card-body'><h1 class=''>Lista de Ventas </h1>  
    ...
    <div class='col-12'>
      ...
      <template v-slot:cell(Acciones)='data'>
          ...
          <b-button-group>
            <b-button v-if="$can('Ventas Editar')"  v-b-modal.moda-registro size='sm' variant='warning' @click='editar_registro(data.item.id)' type='button' class='btn-sm btn btn-wangir mr-1' data-toggle='button' aria-pressed='false' style='margin-bottom: 5px; margin: 5px;'>Editar
            </b-button>
